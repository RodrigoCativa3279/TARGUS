    ...
    <>
      ...
      {!gameStarted && (
        <div className="menu-container">
          ...
          <button className="start-btn" onClick={startGame}>Jugar</button>
        </div>
      )}
        ...
        <div className="sopa-wrapper">
          <div className={`sopa-container ${hasWon ? "blur-board" : ""}`}>
            <div className="buttons-group">
              <button className="hint-btn" onClick={giveHint}>Pista</button>
              <button className="reveal-btn" onClick={revealAll}>Revelar</button>
            </div>
