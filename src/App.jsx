          ...
          <div className="grid-juegos">
            <Link to="/crucigrama" className="juego enlace-juego">
              <figure>
                <img
                  src={juego1}
                  alt="Vista previa del juego Crucigrama"
                  loading="lazy"
                />
                <figcaption>
                  <h2 className="tituloJuego">Crucigrama</h2>
                  <p className="descripcion">
                    ¡Desafía tu mente y divertite completando el crucigrama!
                  </p>
                </figcaption>
              </figure>
            </Link>
            ...
            <Link to="/sudoku" className="juego enlace-juego">
              <figure>
                <img
                  src={juego2}
                  alt="Vista previa del juego Sudoku"
                  loading="lazy"
                />
                <figcaption>
                  <h2 className="tituloJuego">Sudoku</h2>
                  <p className="descripcion">
                    Entrená tu lógica y resolución con desafíos diarios.
                  </p>
                </figcaption>
              </figure>
            </Link>
            ...
            <Link to="/sopa-de-letras" className="juego enlace-juego">
              <figure>
                <img
                  src={juego3}
                  alt="Vista previa del juego Sopa de Letras"
                  loading="lazy"
                />
                <figcaption>
                  <h2 className="tituloJuego">Sopa de letras</h2>
                  <p className="descripcion">
                    Encontrá las palabras ocultas y mejorá tu atención visual.
                  </p>
                </figcaption>
              </figure>
            </Link>
          ...
          <div className="grid-juegos">
            <Link to="/wordle" className="juego enlace-juego">
              <figure>
                <img
                  src={juego4}
                  alt="Vista previa del juego Adivina la palabra"
                  loading="lazy"
                />
                <figcaption>
                  <h2 className="tituloJuego">Adivina la palabra</h2>
                  <p className="descripcion">
                    Descubrí la palabra secreta antes de quedarte sin intentos.
                  </p>
                </figcaption>
              </figure>
            </Link>

            <Link to="/mayor-o-menor" className="juego enlace-juego">
              <figure>
                <img
                  src={juego5}
                  alt="Vista previa del juego Mayor o Menor"
                  loading="lazy"
                />
                <figcaption>
                  <h2 className="tituloJuego">¿Mayor o menor?</h2>
                  <p className="descripcion">
                    Probá tu intuición comparando datos y estadísticas.
                  </p>
                </figcaption>
              </figure>
            </Link>
            ...
            <Link to="/adivina-pais" className="juego enlace-juego">
              <figure>
                <img
                  src={juego6}
                  alt="Vista previa del juego Adivina el país"
                  loading="lazy"
                />
                <figcaption>
                  <h2 className="tituloJuego">Adivina el país</h2>
                  <p className="descripcion">
                    ¿Podés reconocer cada país con solo su bandera? ¡Demostrá tu
                    conocimiento!
                  </p>
                </figcaption>
              </figure>
