    ...
    <>
      ...
      <div className="two-options">
        <div
          ...
          style={{ backgroundImage: `url(${lastVideo.snippet.thumbnails.high.url})` }}
        >
          <div className="overlay"></div>
          <div className="content">
            <h2>"{lastVideo.snippet.title}"</h2>
            <p className="views">
              {Number(lastVideo.statistics.viewCount).toLocaleString()} vistas
            </p>
          </div>
        </div>
        ...
        <div
          className="video-section"
          style={{ backgroundImage: `url(${firstVideo.snippet.thumbnails.high.url})` }}
        >
          <div className="overlay"></div>
          <div className="content">
            ...
            <p className="views">
              ¿Tiene más o menos visualizaciones que {lastVideo.snippet.title}?
            </p>
          </div>
